...
| | |
---|---
**Data in Database** | Glycan structures, as images, GlycoCT and WURCS, and their motifs,<br>monosaccharides and linked to other related databases including GlycomeDB, BCSDB, GlycoEpitope, with others continuing to be added. Each glycan structure is assigned a GlyTouCan ID.
